...
public class IMC extends JFrame {
	...
	public IMC() {
		...
		JLabel lblDigiteSuaCircuferencia = new JLabel("Digite sua circuferêcia do quadril(cm):\r\n");
		lblDigiteSuaCircuferencia.setBounds(72, 301, 224, 19);
		...
		btnNewButton.setFont(new Font("Noto Serif", Font.BOLD, 10));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					double iac = (qua / (alt * alt)) - 18;
					 ...
					 if (imc < 18.5) {
						resultadoIMCLabel.setText(String.format("IMC: " + imc + "(Você está abaixo do peso!)"));
				        } else if (imc < 24.9) {
		...
		btnNewButton.setBounds(158, 385, 85, 21);
		...
		JLabel resultadoIAC = new JLabel("");
